 ...
 *      Use SL_WIFI_SCAN_TYPE_EXTENDED to get scan results more than SL_WIFI_MAX_SCANNED_AP. There is no limit on number of scan results in this scan type and is only limited by amount of dynamic memory host can provide.
 ...
 *      In case of SL_WIFI_SCAN_TYPE_EXTENDED scan type, Use @ref sl_wifi_get_stored_scan_results() API to get the scan results after scan status callback is received. 
 ******************************************************************************/
 ...
 *   Pointer to structure of type @ref sl_wifi_extended_scan_result_parameters_t to return the scan results in
 * @return
