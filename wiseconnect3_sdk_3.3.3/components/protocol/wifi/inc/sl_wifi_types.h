...
typedef struct {
  sl_wifi_extended_scan_result_t
    *scan_results;               ///< Pointer to array of scan results of type @ref sl_wifi_extended_scan_result_t
  uint16_t array_length;         ///< Length of scan results array provided by user.
  uint16_t *result_count;        ///< Pointer to hold total count of scan results being returned.
  uint8_t *channel_filter;       ///< Pointer to Channel number to Filter based on Channel number of the AP
  uint8_t *security_mode_filter; ///< Pointer to Security mode to Filter based on Security mode of the AP
  uint8_t *rssi_filter; ///< Pointer to RSSI to Filter for APs with RSSI greater than or equal to given RSSI value
  uint8_t *network_type_filter; ///< Pointer to Network type to Filter based on AP network type
